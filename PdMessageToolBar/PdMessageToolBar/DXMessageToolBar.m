...
@property (assign, nonatomic) BOOL styleChangeButtonHide;
...
//60录音倒计时
@property (nonatomic, strong) NSTimer *tryTimer;
@property (nonatomic, readwrite) BOOL tryTimerDone;
...
- (void)hideVoiceButton:(BOOL)hide
{
    self.styleChangeButtonHide = hide;
}
...
//    [self.styleChangeButton setImage:[UIImage imageNamed:@"chatBar_keyboard"] forState:UIControlStateSelected];
    [self.styleChangeButton setImage:[UIImage imageNamed:@"Down_Button_Speaker"] forState:UIControlStateNormal];
    [self.styleChangeButton setImage:[UIImage imageNamed:@"Down_Button_keyBoard"] forState:UIControlStateSelected];
    ...
    self.styleChangeButton.hidden = self.styleChangeButtonHide;
...
//    [self.moreButton setImage:[UIImage imageNamed:@"chatBar_keyboard"] forState:UIControlStateSelected];
    self.moreButton.backgroundColor = [UIColor colorWithRed:245/255.0 green:245/255.0 blue:245/255.0 alpha:1];
    [self.moreButton setImage:[UIImage imageNamed:@"Down_Button_add"] forState:UIControlStateNormal];
    [self.moreButton setImage:[UIImage imageNamed:@"Down_Button_add"] forState:UIControlStateHighlighted];
    [self.moreButton setImage:[UIImage imageNamed:@"Down_Button_keyBoard"] forState:UIControlStateSelected];
...
//    [self.faceButton setImage:[UIImage imageNamed:@"chatBar_keyboard"] forState:UIControlStateSelected];
    self.faceButton.backgroundColor = [UIColor colorWithRed:245/255.0 green:245/255.0 blue:245/255.0 alpha:1];
    [self.faceButton setImage:[UIImage imageNamed:@"Down_Button_face"] forState:UIControlStateNormal];
    [self.faceButton setImage:[UIImage imageNamed:@"Down_Button_face"] forState:UIControlStateHighlighted];
    [self.faceButton setImage:[UIImage imageNamed:@"Down_Button_keyBoard"] forState:UIControlStateSelected];
...
#pragma mark - 60秒倒计时
static int timerCounter = 60;

- (void)timerStart
{
    timerCounter = 61;
    _tryTimerDone = NO;
    _tryTimer = [[NSTimer alloc] initWithFireDate:[NSDate date]
                                         interval:1
                                           target:self
                                         selector:@selector(timerComeDown)
                                         userInfo:nil
                                          repeats:YES];
    NSRunLoop *runLoop = [NSRunLoop currentRunLoop];
    [runLoop addTimer:_tryTimer forMode:NSDefaultRunLoopMode];
}
...
- (void)recordButtonTouchUpInside
{
    ...
    {
        if ((_tryTimer && _tryTimerDone) || !_tryTimerDone) {
